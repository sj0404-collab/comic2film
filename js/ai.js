...
export const CURATED_PROVIDERS = {
  ...
  opencode: {
    ...
    models: [
      ...
      { id: 'muse-spark-1.3-contributor-free', free: true, nokey: true, label: 'Muse Spark 1.3 (без ключа)' },
      { id: 'muse-spark-1.2-contributor-free', free: true, nokey: true, label: 'Muse Spark 1.2 (без ключа)' },
      { id: 'deepseek-v4-flash-free', free: true, nokey: true, label: 'DeepSeek V4 Flash (без ключа · провайдер временно недоступен)' },
